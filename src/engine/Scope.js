...
function Scope(parent) {
    ...
    Scope.prototype.put = function(k, v) {
    ...
    Scope.prototype.putLocal = function(k, v) {
    ...
    Scope.prototype.get = function(k) {
    ...
    Scope.prototype.containsKey = function(k) {
    ...
    Scope.prototype.keySet = function() {
        var pks = [];
    ...
    Scope.prototype.localKeySet = function() {
    ...
    Scope.prototype.join = function(m, l) {
    ...
    Scope.prototype.clean = function() {
